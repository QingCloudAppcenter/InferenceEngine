...
prepareDir() {
  mkdir -p /data/logs && chgrp -R syslog /data/logs && chmod 775 /data/logs && mkdir -p /data/models_to_load && chmod -R 777 /data/models_to_load  && chmod -R +rx /opt/models && cp -rf /opt/models /data/
}
